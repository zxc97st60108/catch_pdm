...
HD_PWD='D:/Vivado/catch_pdm/catch_pdm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log input_pdm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source input_pdm.tcl -notrace
