...
HD_PWD='D:/Vivado/catch_pdm/catch_pdm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log input_pdm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source input_pdm.tcl
