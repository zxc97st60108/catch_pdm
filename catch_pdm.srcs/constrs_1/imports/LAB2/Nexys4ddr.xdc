...
#create_clock -add -name sys_clk_pin -period 666.66 -waveform {0 333} [get_ports { clock }];
#set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clock }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
set_property CLOCK_DEDICATED_ROUTE FALSE  [get_nets { clock }];     #  clock ¿é¤J
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { clk }];.
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { clock }];     #  clock ¿é¤J888888888888888888888888
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { pdm_data }];  #  pdm_signal ¿é¤J77777777777777777
#create_clock -add -name pdm_clk_pin -period 4 -waveform {0 2} [get_ports { pdm_data }];
##swiches
...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { pdm }]; #IO_L18P_T2_A24_15 Sch=led[0]
